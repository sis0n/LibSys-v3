document.addEventListener("DOMContentLoaded", () => {
    ...
    async function fetchStudents(page = 1) {
        ...
        try {
            const res = await fetch(`api/superadmin/studentPromotion/fetch?${params}`);
    ...
    promoteBtn.onclick = async () => {
        ...
        try {
            const res = await fetch(`api/superadmin/studentPromotion/promote`, {
                method: 'POST',
    ...
    deactivateBtn.onclick = async () => {
        ...
        try {
            const res = await fetch(`api/superadmin/studentPromotion/deactivate`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    is_all: isGlobalSelect,
    ...
    activateBtn.onclick = async () => {
        ...
        try {
            const res = await fetch(`api/superadmin/studentPromotion/activate`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    is_all: isGlobalSelect,
