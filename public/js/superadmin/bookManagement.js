document.addEventListener("DOMContentLoaded", () => {
    ...
    const fetchBooks = async () => {
        try {
            ...
            const response = await fetch(`api/superadmin/booksmanagement/fetch?${params}`);
    ...
    window.viewBook = async (id) => {
        try {
            const response = await fetch(`api/superadmin/booksmanagement/details/${id}`);
            const data = await response.json();
            if (data.success) {
    ...
    window.deleteBook = async (id, title) => {
        ...
        if (result.isConfirmed) {
            try {
                const response = await fetch(`api/superadmin/booksmanagement/delete/${id}`, { method: "POST" });
                const data = await response.json();
                if (data.success) {
    ...
    addBookForm.addEventListener("submit", async (e) => {
        ...
        try {
            const response = await fetch("api/superadmin/booksmanagement/add", {
                method: "POST",
                body: formData,
            });
            const data = await response.json();
    ...
    editBookForm.addEventListener("submit", async (e) => {
        ...
        try {
            const response = await fetch(`api/superadmin/booksmanagement/update/${bookId}`, {
                method: "POST",
                body: formData,
            });
            const data = await response.json();
    ...
    multiDeleteBtn.addEventListener("click", async () => {
        ...
        if (result.isConfirmed) {
            try {
                const response = await fetch("api/superadmin/booksmanagement/deleteMultiple", {
                    method: "POST",
