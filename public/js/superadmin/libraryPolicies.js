        ...
        (policy) => `
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow text-left">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <button class="edit-policy-btn w-full mt-4 flex items-center justify-center gap-2 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 hover:border-orange-400 hover:text-orange-600 transition-all font-semibold" data-role="${policy.role}">
