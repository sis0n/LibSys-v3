document.addEventListener("DOMContentLoaded", function () {
  ...
  const loadPolicies = async () => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/api/superadmin/libraryPolicies/getAll?campus_id=${campusId}`);
  ...
  editPolicyForm.addEventListener("submit", async (e) => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/api/superadmin/libraryPolicies/update`, {
        method: "POST",
