document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadEquipments(page = 1, showModal = true) {
        ...
        try {
            const res = await fetch(`api/librarian/equipmentManagement/fetch?${params}`);
    ...
    window.toggleActive = async (id, currentIsActive, name) => {
        ...
        try {
            ...
            const res = await fetch(`api/librarian/equipmentManagement/toggleActive/${id}`, { method: "POST", body: fd });
            const data = await res.json();
            Swal.close();
            if (data.success) {
    ...
    window.editEq = async (id) => {
        ...
        try {
            const res = await fetch(`api/librarian/equipmentManagement/get/${id}`);
            const data = await res.json();
            Swal.close();
            if (data.success) {
    ...
    window.deleteEq = async (id, name) => {
        ...
        try {
            const res = await fetch(`api/librarian/equipmentManagement/delete/${id}`, { method: "POST" });
            const data = await res.json();
            Swal.close();
            if (data.success) {
    ...
    addForm.onsubmit = async (e) => {
        ...
        try {
            const res = await fetch(`api/librarian/equipmentManagement/store`, { method: "POST", body: fd });
            const data = await res.json();
            Swal.close();
            if (data.success) {
    ...
    editForm.onsubmit = async (e) => {
        ...
        try {
            const res = await fetch(`api/librarian/equipmentManagement/update/${id}`, { method: "POST", body: fd });
            const data = await res.json();
            Swal.close();
            if (data.success) {
