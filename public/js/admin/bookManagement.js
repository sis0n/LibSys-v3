document.addEventListener("DOMContentLoaded", () => {
    ...
    const fetchBooks = async () => {
        try {
            ...
            const response = await fetch(`api/admin/booksmanagement/fetch?${params}`);
    ...
    window.viewBook = async (id) => {
        try {
            const response = await fetch(`api/admin/booksmanagement/details/${id}`);
            const data = await response.json();
            if (data.success) {
    ...
    window.deleteBook = async (id, title) => {
        ...
        if (result.isConfirmed) {
            try {
                const response = await fetch(`api/admin/booksmanagement/delete/${id}`, { method: "POST" });
                const data = await response.json();
                if (data.success) {
    ...
    addBookForm.addEventListener("submit", async (e) => {
        ...
        try {
            const response = await fetch("api/admin/booksmanagement/add", {
                method: "POST",
                body: formData,
            });
            const data = await response.json();
    ...
    editBookForm.addEventListener("submit", async (e) => {
        ...
        try {
            const response = await fetch(`api/admin/booksmanagement/update/${bookId}`, {
                method: "POST",
                body: formData,
            });
            const data = await response.json();
    ...
    multiDeleteBtn.addEventListener("click", async () => {
        ...
        if (result.isConfirmed) {
            try {
                const response = await fetch("api/admin/booksmanagement/deleteMultiple", {
                    method: "POST",
