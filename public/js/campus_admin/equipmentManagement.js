document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadEquipments(page = 1, showModal = true) {
        ...
        try {
            const res = await fetch(`api/campus_admin/equipmentManagement/fetch?${params}`);
    ...
    multiDeleteBtn.addEventListener("click", async () => {
        ...
        try {
            ...
            const response = await fetch("api/campus_admin/equipmentManagement/deleteMultiple", {
                method: "POST",
    ...
    window.toggleActive = async (id, currentIsActive, name) => {
        ...
        try {
            ...
            const res = await fetch(`api/campus_admin/equipmentManagement/toggleActive/${id}`, { method: "POST", body: fd });
            const data = await res.json();
            Swal.close();
            if (data.success) {
    ...
    window.editEq = async (id) => {
        ...
        try {
            const res = await fetch(`api/campus_admin/equipmentManagement/get/${id}`);
            const data = await res.json();
            Swal.close();
            if (data.success) {
    ...
    window.deleteEq = async (id, name) => {
        ...
        try {
            const res = await fetch(`api/campus_admin/equipmentManagement/delete/${id}`, { method: "POST" });
            const data = await res.json();
            Swal.close();
            if (data.success) {
    ...
    addForm.onsubmit = async (e) => {
        ...
        try {
            const res = await fetch(`api/campus_admin/equipmentManagement/store`, { method: "POST", body: fd });
            const data = await res.json();
            Swal.close();
            if (data.success) {
    ...
    editForm.onsubmit = async (e) => {
        ...
        try {
            const res = await fetch(`api/campus_admin/equipmentManagement/update/${id}`, { method: "POST", body: fd });
            const data = await res.json();
            Swal.close();
            if (data.success) {
