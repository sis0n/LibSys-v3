document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchData() {
        ...
        try {
            ...
            const res = await fetch(`${BASE_URL_JS}/api/campus_admin/overdue/getTableData?search=${encodeURIComponent(search)}&urgency=${urgency}`);
    ...
    tableBody.addEventListener('click', async (e) => {
        ...
        try {
            const res = await fetch(`${BASE_URL_JS}/api/campus_admin/overdue/sendReminder`, {
                method: 'POST',
