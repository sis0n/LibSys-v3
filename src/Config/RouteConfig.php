...
class RouteConfig
{
  public static function register(): Router
  {
    ...
    $router->get('api/librarian/equipmentManagement/fetch', 'EquipmentManagementController@getAll', ['equipment management']);
    ...
    $router->post('api/librarian/equipmentManagement/delete/{id}', 'EquipmentManagementController@destroy', ['equipment management']);
    ...
    $router->get('api/admin/equipmentManagement/fetch', 'EquipmentManagementController@getAll', ['equipment management']);
    ...
    $router->post('api/admin/equipmentManagement/delete/{id}', 'EquipmentManagementController@destroy', ['equipment management']);
