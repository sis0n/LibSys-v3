        ...
        <div class="flex-1 bg-[var(--color-card)] rounded-[var(--radius-lg)] shadow-md border border-[var(--color-border)] p-6 flex flex-col">
            ...
            <dl class="space-y-3 text-sm flex-1">
                <div class="flex justify-between items-center">
                    <dt class="text-amber-700 font-medium">Employee ID:</dt>
                    <dd id="detailsStudentNumber" class="text-right"><?= htmlspecialchars($staff["staff_id"] ?? "N/A") ?></dd>
                </div>
                <div class="flex justify-between items-center">
                    <dt class="text-amber-700 font-medium">Name:</dt>
                    <dd id="detailsStudentName" class="text-right"><?= htmlspecialchars($staff["name"] ?? "Staff Name") ?></dd>
                </div>
                <div class="flex justify-between items-center">
                    <dt class="text-amber-700 font-medium">Department/Position:</dt>
                    <dd id="detailsStudentCourse" class="text-right"><?= htmlspecialchars($staff["department"] ?? "N/A") ?></dd>
                </div>
                <div class="flex justify-between items-center">
