...
<main class="min-h-screen">
    <h2 class="text-2xl font-bold mb-4">Staff QR Borrowing Ticket</h2>
    <p class="text-gray-700">Your QR code for staff book borrowing.</p>
    ...
    <div class="container mx-auto px-4 py-6 flex flex-col md:flex-row gap-6 justify-center items-stretch">
        ...
        <div class="flex-1 bg-[var(--color-card)] rounded-[var(--radius-lg)] shadow-md border border-[var(--color-border)] p-6 flex flex-col">
            <h3 class="text-md font-medium mb-1">Staff Info</h3>
            <p class="text-sm text-amber-700 mb-5">Encoded ticket data</p>
            <dl class="space-y-3 text-sm flex-1">
                <div class="flex justify-between items-center"><dt class="text-amber-700 font-medium">Employee ID:</dt><dd id="detailsStudentNumber" class="text-right"><?= htmlspecialchars($staff["staff_id"] ?? "N/A") ?></dd></div>
                <div class="flex justify-between items-center"><dt class="text-amber-700 font-medium">Name:</dt><dd id="detailsStudentName" class="text-right"><?= htmlspecialchars($staff["name"] ?? "Staff Name") ?></dd></div>
                <div class="flex justify-between items-center"><dt class="text-amber-700 font-medium">Position:</dt><dd id="detailsStudentCourse" class="text-right"><?= htmlspecialchars($staff["department"] ?? "N/A") ?></dd></div>
