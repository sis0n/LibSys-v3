...
<head>
    ...
    <title>Library | 403 Forbidden</title>
...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-green-50 font-sans p-6 overflow-hidden">
    ...
    <div class="w-full max-w-md text-center relative z-10">
        ...
        <div class="mb-10">
            <h1 class="text-8xl font-black text-gray-900 tracking-tighter leading-none">403</h1>
            <h2 class="text-xl font-bold text-gray-700 mt-4 uppercase tracking-[0.3em]">Access Denied</h2>
