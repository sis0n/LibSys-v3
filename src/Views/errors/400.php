...
<head>
    ...
    <title>Library | 400 Bad Request</title>
...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-green-50 font-sans p-6 overflow-hidden">
    ...
    <div class="w-full max-w-md text-center relative z-10">
        ...
        <div class="mb-10">
            <h1 class="text-8xl font-black text-gray-900 tracking-tighter leading-none">400</h1>
            <h2 class="text-xl font-bold text-gray-700 mt-4 uppercase tracking-[0.3em]">Bad Request</h2>
        ...
        <p class="text-base text-gray-600 mb-12 leading-relaxed font-medium">
            The server could not understand the request due to invalid syntax. Please try again.
        </p>
        ...
        <div class="flex justify-center mt-6">
            <a href="<?= BASE_URL ?>/"
                ...
                <span class="leading-none">Back to Home</span>
            </a>
        </div>
