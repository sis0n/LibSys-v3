...
<head>
    ...
    <title>Library | 405 Method Not Allowed</title>
...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-green-50 font-sans p-6 overflow-hidden">
    ...
    <div class="w-full max-w-md text-center relative z-10">
        ...
        <div class="mb-10">
            <h1 class="text-8xl font-black text-gray-900 tracking-tighter leading-none">405</h1>
            <h2 class="text-xl font-bold text-gray-700 mt-4 uppercase tracking-[0.3em]">Method Not Allowed</h2>
