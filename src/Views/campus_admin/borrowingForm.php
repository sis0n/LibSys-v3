<main class="min-h-screen">
    ...
    <form id="main-borrow-form">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div id="collateralDropdownMenu" class="absolute mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg hidden z-20 max-h-60 overflow-y-auto">
                                <ul class="py-1" id="collateral-list"></ul>
                            </div>
                        </div>
                    </div>
                    <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-1" id="item_name_wrapper">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="equipmentDropdownBtn" class="w-full flex items-center justify-between px-4 py-2 rounded-lg border border-emerald-300 bg-white text-left focus:ring-2 focus:ring-emerald-500 outline-none transition text-sm">
                            <span id="equipmentDropdownValue">Select Equipment</span>
                            <i class="ph ph-caret-down text-gray-500"></i>
                        </button>
                        <div id="equipmentDropdownMenu" class="absolute mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg hidden z-20 max-h-60 overflow-y-auto">
                            <ul class="py-1" id="equipment-list"></ul>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex justify-end gap-4 mt-6">
            <button type="button" id="check-btn" class="px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-700 transition text-sm font-medium">Check User</button>
            <button type="button" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition text-sm font-medium" id="clear-btn">Clear</button>
            <button type="submit" class="px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-700 transition text-sm font-medium">Submit</button>
        </div>
    </form>
    ...
    <script src="<?= BASE_URL ?>/js/campus_admin/borrowingForm.js" defer></script>
</main>
